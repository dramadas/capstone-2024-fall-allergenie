      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Milk - Includes dairy products like milk, cheese, yogurt, butter, and cream.',
              style: TextStyle(
                color: Color.fromARGB(238, 39, 60, 2),
                fontSize: 14,
                fontStyle: FontStyle.italic, 
            ...
            const SizedBox(height: 4),
            const Text(
              'Egg - Found in foods like mayonnaise, baked goods, and some sauces or dressings.',
              style: TextStyle(
                color: Color.fromARGB(238, 39, 60, 2),
                fontSize: 14,
                fontStyle: FontStyle.italic, 
            ...
            const SizedBox(height: 4),
            const Text(
              'Fish - Includes cod, salmon, tuna, and other finned fish species.',
              style: TextStyle(
                color: Color.fromARGB(238, 39, 60, 2),
                fontSize: 14,
                fontStyle: FontStyle.italic, 
            ...
            const SizedBox(height: 4),
            const Text(
              'Shellfish - Covers crustaceans (shrimp, crab, lobster) and mollusks (clams, oysters, squid).',
              style: TextStyle(
                color: Color.fromARGB(238, 39, 60, 2),
                fontSize: 14,
                fontStyle: FontStyle.italic, 
            ...
            const SizedBox(height: 4),
            const Text(
              'Tree Nut - Includes almonds, walnuts, cashews, pistachios, hazelnuts, and Brazil nuts.',
              style: TextStyle(
                color: Color.fromARGB(238, 39, 60, 2),
                fontSize: 14,
                fontStyle: FontStyle.italic, 
            ...
            const SizedBox(height: 4),
            const Text(
              'Peanut - Found in peanut butter, peanut oil, and snacks like trail mixes.',
              style: TextStyle(
                color: Color.fromARGB(238, 39, 60, 2),
                fontSize: 14,
                fontStyle: FontStyle.italic, 
            ...
            const SizedBox(height: 4),
            const Text(
              'Wheat - Includes bread, pasta, baked goods, and other wheat-based products.',
              style: TextStyle(
                color: Color.fromARGB(238, 39, 60, 2),
                fontSize: 14,
                fontStyle: FontStyle.italic, 
            ...
            const SizedBox(height: 4),
            const Text(
              'Soy - Found in soy sauce, tofu, edamame, and many processed foods.',
              style: TextStyle(
                color: Color.fromARGB(238, 39, 60, 2),
                fontSize: 14,
                fontStyle: FontStyle.italic, 
            ...
            const SizedBox(height: 4),
            const Text(
              'No Allergies - You’re not avoiding any specific allergens.',
              style: TextStyle(
                color: Color.fromARGB(238, 39, 60, 2),
                fontSize: 14,
                fontStyle: FontStyle.italic, 
            ...
            const Text.rich(
              TextSpan(
                children: [
                  ...
                  TextSpan(
                    text: 'Generating AI images may take longer to load. Please be patient as the images are generated by AI and may not fully represent the actual recipe.',
                    style: TextStyle(
                      fontStyle: FontStyle.italic,
                      color: Color.fromARGB(238, 39, 60, 2),
                      fontSize: 14,
